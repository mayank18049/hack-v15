...
"""
import itertools,RPi.GPIO as gpio
import time
WHITE = "white"
BLACK = "black"

a=2;b=3;c=4;d=17;e=27;f=22;g=10;h=9 #ranks
x1=14;x2=15;x3=18;x4=23;x5=24;x6=25;x7=8;x8=7 #files

buzzer=26
gpio.setmode(gpio.BOARD)
ranks=[a,b,c,d,e,f,g,h]
files=[x1,x2,x3,x4,x5,x6,x7,x8]
gpio.setup(ranks, gpio.IN, gpio.PUD_DOWN)
gpio.setup(files, gpio.IN, gpio.PUD_DOWN)
class Game:
		...
		try:
			while 1:
				for channel in ranks:
					gpio.add_event_detect(channel, gpio.FALLING, my_callback1, 0.1)
				for channel in files:
					gpio.add_event_detect(channel, gpio.FALLING, my_callback2, 0.1)
				t+=tuple(ranks.index(posx),files.index(posy)) 
				if count==4:
					return t    
